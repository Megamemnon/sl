...
namespace propositional_calculus
{
  ...
  */
  ...
  theorem
  conjunction_implication_distributive_meta(phi : Formula, psi : Formula,
    chi : Formula)
  {
    assume implies($phi, $psi);
  ...
  theorem
  biconditional_commutation(phi : Formula, psi : Formula)
  {
  ...
  theorem
  conjunction_simplification(phi : Formula, psi : Formula, chi : Formula)
  {
  ...
  theorem
  conjunction_simplification_2(phi : Formula, psi : Formula, chi : Formula)
  {
  ...
  {
    theorem
    conjunction_biconditional_simplification_l1(phi : Formula, psi : Formula,
      chi : Formula)
    {
  ...
  theorem
  conjunction_biconditional_simplification(phi : Formula, psi : Formula,
    chi : Formula)
  {
